...
- "by Riste aka ExploitZ3r0" subtitle under the main title
  now polish the entive wepsite and add trusted by sections with 30 company logos with color
...
- Redirect route `GET /[code]` that looks up the code in Redis and redirects to original URL
